 ...
 * @author M.BAHRIL.I
 */
public class FrmBukumatrix extends javax.swing.JInternalFrame {
private boolean append = false;
private String _filename;
private HashMap _parameter;
private net.sf.jasperreports.swing.JRViewer pracetak;
    /**
     * Creates new form FrmBukumatrix
     */
    public FrmBukumatrix() {
        initComponents();
    }
    ...
    private void FrmBukumatrix(String filename){
    ...
    public void OpsiCetak(){
        if (btampil.getText().equals("Cetak Data Penulis")==true){
            FrmBukumatrix("report_press_bukumatrix.jasper");
        }else{
    ...
    private void initComponents() {
        ...
        jXTitledPanel2.setTitle(" PRINT PREVIEW");
